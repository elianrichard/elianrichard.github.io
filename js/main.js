...
function changeContent(page){
  document.querySelector('.proj-title').innerHTML = projectsLists[page-1].title;
  document.querySelector('.image').querySelector('img').src = projectsLists[page-1].image;
  document.querySelector('.site').href = projectsLists[page-1].site;
  document.querySelector('.active').classList.remove('active');
  document.querySelector(`.scroll div:nth-child(${page})`).classList.add('active');
}
...
function projectContentLoad(){
  ...
  document.querySelector('title').innerHTML = `Projects - ${projectsLists[projectNumber].heading}`
  document.querySelector('.text').querySelector('h1').innerHTML = projectsLists[projectNumber].heading;
  document.querySelector('.main-image').querySelector('img').src = projectsLists[projectNumber].image;
  document.querySelector('.project-desc').querySelector('.title').innerHTML = projectsLists[projectNumber].title;
  document.querySelector('.project-desc').querySelector('.detail').innerHTML = projectsLists[projectNumber].detail;
