var bidangKominfo = {
    namaBidang: 'Komunikasi dan Informasi',
    bidangNickname: 'kominfo',
    deskripsiBidang: 'Bidang Komunikasi dan Informasi merupakan bidang pelayanan informasi serta menjalin hubungan baik dengan internal maupun eksternal DTE.',
    logoBidang: 'assets/logbid/kominfo.png',
    programKerja: 'Grand Launching, Grand Closing, PSB Genap, PSB Ganjil, Sosial Media, IME on Youtube, Mading, Studi Banding, Sharing Session',
    videoBidang: 'https://www.youtube.com/embed/XloC_6NwUEg',
    fotoBidang: [
        'assets/foto-bidang/party-1.jpg',
        'assets/foto-bidang/party-2.jpg',
        'assets/foto-bidang/party-3.jpg',
        'assets/foto-bidang/party-4.jpg',
        'assets/foto-bidang/party-5.jpg',
        'assets/foto-bidang/party-6.jpg',
        'assets/foto-bidang/party-7.jpg',
        'assets/foto-bidang/party-8.jpg',
        'assets/foto-bidang/party-9.jpg',
        'assets/foto-bidang/party-10.jpg',
    ],
    namaBPH: [
        {
            nama: 'Fikri Faza',
            jabatan: 'Wakil Kepala Bidang',
            foto: 'assets/pikray.png',
            display: 'block',
        },
        {
            nama: 'Shafa Tasya',
        ...
        {
            nama: 'Elian Richard',
            jabatan: 'Staff Ahli Media',
            foto: '',
            display: 'block'
        },
        {
            nama: 'Amalia Kumala',
            jabatan: 'Staff Ahli Relasi',
            foto: '',
            display: 'block'
        },
        {
...
var bidangKema = {
    ...
    namaBP: [
        {
            nama: "Raihan Fakhar E'20",
            foto: '',
            display: 'static'
        },
        {
            nama: "Salman Elfarizi E'20",
            foto: '',
            display: 'static'
        },
        {
            nama: "Athaya Mahira E'20",
            foto: '',
            display: 'static'
        },
        {
        ...
        {
            nama: "Binar Qalbu TKom'20",
            foto: '',
            display: 'static'
        },
        {
            nama: "Anzelya L. Biom'20",
            foto: '',
            display: 'static'
        },
        {
            nama: "Yasna Masye Biom'20",
            foto: '',
            display: 'static'
        },
        {
            nama: "Steve Immanuel Biom'20",
            foto: '',
            display: 'static'
        },
        {
            nama: "Airell R. Tkom'20",
            foto: '',
            display: 'static'
        },
        {
        ...
        {
            nama: "M. Darrel Tkom'20",
            foto: '',
            display: 'static'
        },
        {
            nama: "Erfina Arthur Biom'20",
            foto: '',
            display: 'static'
        },
        {
...
var bidangKastrat = {
    namaBidang: 'Kajian dan Aksi Strategis',
...
var bidangKewirus = {
    namaBidang: 'Keuangan dan Kewirausahaan',
...
var bidangKesma = {
    namaBidang: 'Kesejahteraan Mahasiswa',
...
var bidangPengmas = {
    namaBidang: 'Pengabdian Masyarakat',
...
var bidangLitbang = {
    namaBidang: 'Penelitian dan Pengembangan',
...
var bidangRetro = {
    namaBidang: 'Rohani Islam Elektro',
...
var bidangPiptek = {
    namaBidang: 'Pengembangan Ilmu Pengetahuan dan Teknologi',
...
var bidangAkpro = {
    namaBidang: 'Akademis dan Keprofesian',
